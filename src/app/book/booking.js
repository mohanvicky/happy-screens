        ...
        <Stack spacing={3}>
          ...
          {bookingForm.location && availableScreens.length > 0 && (
            <Box>
              ...
              {/* Screen Cards - Show only 3 at a time */}
                  ...
                  <Grid item xs={12} sm={6} lg={4} key={screen.id}>
                    <Card
                      sx={{
                        ...
                        '&:hover': {
                          transform: bookingForm.screen !== screen.id ? 'translateY(-4px)' : 'none',
                          boxShadow: bookingForm.screen !== screen.id ? 4 : 8
                        }
                      }}
                      onClick={() => {
                    ...
                    >
                      ...
                      <Box sx={{ position: 'relative', overflow: 'hidden' }}>
                        {screen.images && screen.images[0] ? (
                          ...
                          <Box sx={{
                            ...
                            <Movie sx={{ fontSize: isMobile ? 40 : 50, color: 'grey.400', mb: 1 }} />
                            <Typography variant="caption" color="text.secondary">
                              Screen Preview
                            </Typography>
                          </Box>
                      ...
                      <CardContent sx={{ p: isMobile ? 1.5 : 2, flexGrow: 1, display: 'flex', flexDirection: 'column' }}>
                        {/* Title */}
                          ...
                          <Box sx={{ mt: 'auto' }}>
                            ...
                            <Stack direction="row" flexWrap="wrap" gap={0.5}>
                              ...
                              {screen.amenities.length > (isMobile ? 2 : 3) && (
                                <Chip
                                  label={`+${screen.amenities.length - (isMobile ? 2 : 3)}`}
                                  size="small"
                                  color="primary"
                                  sx={{ fontSize: '0.7rem', height: 20 }}
                                />
